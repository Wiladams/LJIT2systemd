...
--[[
local function SD_ID128_ARRAY(v0, v1, v2, v3, v4, v5, v6, v7, v8, v9, v10, v11, v12, v13, v14, v15)
...
local function sd_id128_equal(a, b)
    return a.qwords[0] == b.qwords[0] and
        a.qwords[1] == b.qwords[1]

    --return memcmp(&a, &b, 16) == 0;
end

local function sd_id128_is_null(a)
        return a.qwords[0] == 0 and a.qwords[1] == 0;
end
