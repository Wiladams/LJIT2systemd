...
enum {
        ...
        SD_BUS_CREDS_WELL_KNOWN_NAMES   = 1 << 32,
        SD_BUS_CREDS_DESCRIPTION        = 1 << 33,
        SD_BUS_CREDS_AUGMENT            = 1 << 63, /* special flag, if on sd-bus will augment creds struct, in a potentially race-full way. */
        _SD_BUS_CREDS_ALL               = (1 << 34) -1,
};
]]
...
require("sd-bus-protocol")
require("sd-bus-vtable")
